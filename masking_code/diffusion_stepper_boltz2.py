"""Implements single diffusion steps and partial diffusion for Boltz-2.

Author: Karson Chrispens
Last Updated: 10 March 2026, by Joyce Mo for Boltz2 
...
class PredictArgs:
    ...
    recycling_steps: int = 0  # default in Boltz2
...
class DiffusionStepper:
    """Controls fine-grained diffusion steps using the pretrained Boltz2 model.
    ...
    def __init__(
        ...
        model : Optional[Boltz2], optional
...
class DensityGuidedDiffusionStepper(DiffusionStepper):
    """Controls fine-grained diffusion steps using the pretrained Boltz2 model and guidance via the diffusion update"""
